...
import static rocks.zipcode.domain.MentionAsserts.*;
...
class MentionResourceIT {
    ...
    public static Mention createEntity(EntityManager em) {
        Mention mention = new Mention().userName(DEFAULT_USER_NAME).text(DEFAULT_TEXT);
        return mention;
    }
    ...
    public static Mention createUpdatedEntity(EntityManager em) {
        Mention mention = new Mention().userName(UPDATED_USER_NAME).text(UPDATED_TEXT);
        return mention;
    }
    ...
    void putExistingMention() throws Exception {
        ...
        updatedMention.userName(UPDATED_USER_NAME).text(UPDATED_TEXT);
    ...
    void partialUpdateMentionWithPatch() throws Exception {
        ...
        partialUpdatedMention.userName(UPDATED_USER_NAME);
    ...
    void fullUpdateMentionWithPatch() throws Exception {
        ...
        partialUpdatedMention.userName(UPDATED_USER_NAME).text(UPDATED_TEXT);
