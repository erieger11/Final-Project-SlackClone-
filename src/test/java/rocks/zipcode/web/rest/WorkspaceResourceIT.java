...
import static rocks.zipcode.domain.WorkspaceAsserts.*;
...
import rocks.zipcode.repository.WorkspaceRepository;
...
class WorkspaceResourceIT {
    ...
    public static Workspace createEntity(EntityManager em) {
        Workspace workspace = new Workspace().name(DEFAULT_NAME).status(DEFAULT_STATUS);
        return workspace;
    }
    ...
    public static Workspace createUpdatedEntity(EntityManager em) {
        Workspace workspace = new Workspace().name(UPDATED_NAME).status(UPDATED_STATUS);
        return workspace;
    }
    ...
    void putExistingWorkspace() throws Exception {
        ...
        updatedWorkspace.name(UPDATED_NAME).status(UPDATED_STATUS);
    ...
    void fullUpdateWorkspaceWithPatch() throws Exception {
        ...
        partialUpdatedWorkspace.name(UPDATED_NAME).status(UPDATED_STATUS);
