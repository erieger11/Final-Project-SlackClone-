...
import static rocks.zipcode.domain.MessageAsserts.*;
...
class MessageResourceIT {
    ...
    private static final String DEFAULT_UPLOADS = "AAAAAAAAAA";
    private static final String UPDATED_UPLOADS = "BBBBBBBBBB";

    private static final Integer DEFAULT_PINNED = 1;
    private static final Integer UPDATED_PINNED = 2;
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().uploads(DEFAULT_UPLOADS).pinned(DEFAULT_PINNED).timestamp(DEFAULT_TIMESTAMP);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().uploads(UPDATED_UPLOADS).pinned(UPDATED_PINNED).timestamp(UPDATED_TIMESTAMP);
        return message;
    }
    ...
    void getAllMessages() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.[*].uploads").value(hasItem(DEFAULT_UPLOADS)))
            .andExpect(jsonPath("$.[*].pinned").value(hasItem(DEFAULT_PINNED)))
    ...
    void getMessage() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.uploads").value(DEFAULT_UPLOADS))
            .andExpect(jsonPath("$.pinned").value(DEFAULT_PINNED))
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.uploads(UPDATED_UPLOADS).pinned(UPDATED_PINNED).timestamp(UPDATED_TIMESTAMP);
    ...
    void partialUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.pinned(UPDATED_PINNED).timestamp(UPDATED_TIMESTAMP);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.uploads(UPDATED_UPLOADS).pinned(UPDATED_PINNED).timestamp(UPDATED_TIMESTAMP);
