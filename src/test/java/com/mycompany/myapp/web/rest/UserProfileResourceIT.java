...
class UserProfileResourceIT {
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.fullName(UPDATED_FULL_NAME).timezone(UPDATED_TIMEZONE).phone(UPDATED_PHONE).status(UPDATED_STATUS);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.phone(UPDATED_PHONE).status(UPDATED_STATUS);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.fullName(UPDATED_FULL_NAME).timezone(UPDATED_TIMEZONE).phone(UPDATED_PHONE).status(UPDATED_STATUS);
