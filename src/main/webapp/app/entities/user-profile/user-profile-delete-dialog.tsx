...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="slackCloneTempApp.userProfile.delete.question">
        <Translate contentKey="slackCloneTempApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
