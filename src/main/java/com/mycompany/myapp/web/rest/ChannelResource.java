...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Channel}.
 */
@RestController
...
public class ChannelResource {
    ...
    public ResponseEntity<Channel> createChannel(@Valid @RequestBody Channel channel) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/channels/" + channel.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, channel.getId().toString()))
            .body(channel);
    }
