...
/**
 * REST controller for managing {@link rocks.zipcode.domain.Workspace}.
 */
@RestController
...
public class WorkspaceResource {
    ...
    public ResponseEntity<Workspace> createWorkspace(@Valid @RequestBody Workspace workspace) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/workspaces/" + workspace.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, workspace.getId().toString()))
            .body(workspace);
    }
